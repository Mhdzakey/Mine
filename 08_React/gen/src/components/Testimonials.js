...
const Testimonials = (props) => {
  ...
  function surpriseHandler(){
    let randomIndex = Math.floor(Math.random() * reviews.lenght);
    setIndex(randomIndex);
  }
    return (
    <div className='w-[85vw] md:w-[700px] bg-white flex flex-col justify-center 
    items-center mt-10 p-10 transition-all duration-500 hover:shadow-xl rounded-md '>
        <Card review ={reviews[index]}></Card>

        <div className='flex text-3xl mt-5 gap-3 to-violet-400 font-bold mx-auto'>
        ...
        <div>
            ...
            cursor-pointer px-2 py-2 rounded-md font-bold text-white text-lg '>Surprise Me</button>
        </div>
